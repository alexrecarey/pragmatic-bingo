...
Elm.Main.make = function (_elm) {
   ...
   var _op = {};
   var characters = A2($Signal.map,
   $Char.fromCode,
   $Keyboard.presses);
   var pressedDigit = A2($Signal.map,$Char.isDigit,characters);
   var main = A2($Signal.map,$Graphics$Element.show,pressedDigit);
   var area = function (_p0) {
      var _p1 = _p0;
      return _p1._0 * _p1._1;
   };
   var windowArea = A2($Signal.map,area,$Window.dimensions);
